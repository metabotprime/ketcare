...
export const PRIVACY_POLICY: LegalContent[] = [
  ...
  'Should you seek more details on our data handling approaches, have inquiries, or wish to submit a request, feel free to connect with us via email at care@ketcare.com.',
];
...
export const TERMS_OF_USE: LegalContent[] = [
  ...
  'You are not required to provide this consent as a condition of purchasing or using Ketcare\'s services. If you wish to use our services without receiving sales or marketing messages, please email us at care@ketcare.com so we can update your preferences. You will still receive essential service-related communications, such as account notices or transactional updates.',
  ...
  { heading: 'Contact' },
  'If you have any questions about these Terms, please contact us at care@ketcare.com.',
];
...
export const HEALTH_DATA_PRIVACY: LegalContent[] = [
  ...
  { heading: 'Contact' },
  'If you have questions, requests, or need further information about this Health Data Policy, please contact us at care@ketcare.com.',
];
